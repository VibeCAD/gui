...
7. align: Align an object to a specific edge of another object with perfect perpendicularity and flush contact
  8. describe: Provide a concise text description of the current scene. Use only essential information: object types and colors. Avoid object names, coordinates, and dimensions unless specifically requested.
...
[{"action": "rename", "objectId": "sphere-id", "name": "red-ball"}]
  ...
  [{"action": "describe", "description": "Red cube and green sphere"}]
